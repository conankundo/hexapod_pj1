...
// int y[] = {0, 20};
// int z[] = {133, 133}; 
float x[] = { 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0, 106.0};
float y[] = {-5.0,-4.93,-4.73,-4.4,-3.95,-3.39,-2.73,-2.01,-1.23,-0.41,0.41,1.23,2.01,2.73,3.39,3.95,4.4,4.73,4.93,5.0};
float z[] = {133.0,132.18,131.38,130.62,129.93,129.32,128.81,128.42,128.15,128.02,128.02,128.15,128.42,128.81,129.32,129.93,130.62,131.38,132.18,133.0};
// float theta1=-45.7;
// float theta2=7.1;
// float theta3=96.5;
// float theta1=68;
...
void loop() {
  ...
  for (int i = 0; i < sizeof(z)/sizeof(float); i++ ){
    ...
    pwm_r.setPWM(1, 0, angle(theta[0]+ 90));
    pwm_r.setPWM(5, 0, angle(90 - theta[1]));
    pwm_r.setPWM(9, 0, angle(theta[2]));
    WebSerial.print(theta[0]+ 90); WebSerial.print("//");
    Serial.print(theta[0]+ 90); Serial.print("//");
    WebSerial.print(90 - theta[1]); WebSerial.print("//");
    Serial.print(90 - theta[1]); Serial.print("//");
    WebSerial.print(theta[2]); WebSerial.println("//");
